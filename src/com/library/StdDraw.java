 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use standard drawing, you must have {@code Library.StdDraw.class} in your
 ...
 *  test.control drawing parameters.
 ...
 *  and {@code Library.StdDraw.setPenColor()} test.control the line thickness and color.
 *  <p>
 ...
 *  The following methods test.control the way in which objects are drawn:
 *  <ul>
 ...
 *  <p>
 *  <b>Accessing test.control parameters.</b>
 ...
 *  test.control parameter and reset it back to its original value.
 *  <p>
 *  <b>Corner cases.</b>
...
*/
    ...
    ***************************************************************************/
     ...
     * or modifier keys (such as test.control).
     *
    ...
    *  as an argument. It can handle action keys
     * (such as F1 and arrow keys) and modifier keys (such as shift and test.control).
